...
import Portal.utils.OSUtils;
import Portal.utils.TerminalUtils;
...
import static Portal.utils.report.AllureConstants.HISTORY_FOLDER;
import static Portal.utils.report.AllureConstants.RESULTS_HISTORY_FOLDER;
...
public class AllureReportGenerator {
    ...
    public static String renameReport() {
        ...
        Portal.FileUtils.renameFile(AllureConstants.REPORT_PATH.resolve(AllureConstants.INDEX_HTML).toString(), newFileName);
        return newFileName;
    }
