...
@Story("Validate Duplicate Manifest API")
@Severity(SeverityLevel.NORMAL)
@Owner("Elnems")
public class ValidateDuplicateManifestAPITest {

    private JsonReader testData;

    @Description("Verify duplicate manifest returns 422 error")
    @Test(groups = "manifest")
    public void validateDuplicateManifestTC() {
        new ManifestAPI()
                .createManifest(
